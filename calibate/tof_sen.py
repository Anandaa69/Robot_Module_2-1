...
def calibrate_sensor_linear_regression():
    ...
    sensor_readings = [170, 288, 415, 522, 623, 755, 855, 962, 1062]  # เก็บค่าที่เซ็นเซอร์อ่านได้ (ค่าดิบ)
    actual_distances = [20, 30, 40, 50, 60, 70, 80, 90, 100] # เก็บระยะทางจริงที่วัดได้
    # ---------------------------------
