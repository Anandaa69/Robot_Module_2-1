...
class MazeVisualizer:
    ...
    def create_animation(self, save_file="maze_animation.mp4"):
        ...
        # แก้ไข: กลับแกน Y เพียงอย่างเดียว (ไม่กลับ X)
        ax.invert_yaxis()
    ...
    def create_visualization(self, save_file=None, show_path=True, show_visit_counts=True, show_dead_ends=True):
        ...
        # แก้ไข: ลบการกลับแกน X ออก - กลับแค่แกน Y เพื่อให้ origin อยู่ด้านบน
        # self.ax.invert_xaxis()  # <- ลบบรรทัดนี้ออก
    ...
    def _customize_plot(self):
        ...
        # แก้ไข: กลับแกน Y เพียงอย่างเดียว เพื่อให้ origin อยู่ที่มุมซ้ายบน
