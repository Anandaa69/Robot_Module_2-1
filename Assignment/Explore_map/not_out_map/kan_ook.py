...
class GraphNode:
    def __init__(self, node_id, position):
        ...
        self.outOfBoundsExits = [] # Added from please.py

class GraphMapper:
    def __init__(self, min_x=-100, max_x=100, min_y=-100, max_y=100): # Modified from please.py
...
if __name__ == '__main__':
    ep_robot = None
    # From please.py: Initialize GraphMapper with boundaries
    graph_mapper = GraphMapper(min_x=-5, max_x=0, min_y=0, max_y=5)
