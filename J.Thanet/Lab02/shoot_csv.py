...
g_processed_markers = []
# Global list to store tracking data for CSV export
tracking_data = []
...
if __name__ == '__main__':
    ...
    #----Best----
    #         "yaw": {"kp": 80, "ki": 1.0, "kd": 15},
    #         "pitch": {"kp": 80, "ki": 1.0, "kd": 15}
