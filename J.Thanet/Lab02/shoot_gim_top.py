...
if __name__ == '__main__':
    ...
    # Use smoother PID values to prevent jittery movement
    pid_config = {
        "yaw": {"kp": 100, "ki": 1.0, "kd": 10},
        "pitch": {"kp": 100, "ki": 1.0, "kd": 10}
    }
    ...
    # Initialize PID controllers with smoother values
    ...
    for target_name in sequence:
        ...
        time.sleep(0.2) # Wait for gimbal to settle properly
