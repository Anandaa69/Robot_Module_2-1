...
def main():
    ...
    try:
        while True:
            ...
            # ## [แก้ไข!] ลบเครื่องหมายลบที่ใส่ผิดออกไป ##
            # ตรรกะที่ถูกต้อง:
            # - ถ้าหุ่นอยู่ไกลกำแพงซ้าย -> error_distance เป็นลบ -> ต้องการหมุนซ้าย (z เป็นลบ)
            # - ถ้าหุ่นอยู่ใกล้กำแพงซ้าย -> error_distance เป็นบวก -> ต้องการหมุนขวา (z เป็นบวก)
            # สมการนี้ให้ผลลัพธ์ที่ถูกต้องตามนี้แล้ว
