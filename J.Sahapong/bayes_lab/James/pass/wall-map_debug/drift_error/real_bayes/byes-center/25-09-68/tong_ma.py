...
def perform_centering_nudge(movement_controller, scanner, initial_readings, attitude_handler, occupancy_map, visualizer):
    """
    เวอร์ชันแก้ไข: ทำหน้าที่เป็น "ผู้ตัดสินใจสูงสุด" สำหรับกำแพงด้านซ้ายและขวา
    และอัปเดตแผนที่ด้วยตัวเอง เพื่อป้องกันการเขียนข้อมูลทับ
    """
    ...
    nudge_dist, nudge_dur = 0.075, 0.25
