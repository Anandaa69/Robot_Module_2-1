...
# =============================================================================
class MapCell:
    """Represents a single cell in the maze, storing wall and visit status."""
    def __init__(self):
        self.walls = {'north': False, 'south': False, 'east': False, 'west': False}
        self.visited = False

class MazeMap:
    """Represents the structural map of the maze (4x4 grid of MapCells)."""
    ...
    def set_wall(self, r, c, direction, has_wall):
        if 0 <= r < self.height and 0 <= c < self.width:
            ...
            # Update neighbor's wall as well for consistency
    ...
    def has_wall(self, r, c, direction):
        ...
        return True # Assume walls at boundaries
...
class RealTimeVisualizer:
    """Handles the real-time Matplotlib heatmap pop-up window."""
    ...
    def update_plot(self, maze_map, robot_pos, path=None):
        self.heatmap_data.fill(self.FREE) # Background is white
