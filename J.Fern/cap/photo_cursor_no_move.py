...
def main():
    ...
    # --- [เพิ่มใหม่] กำหนดโหมดหุ่นยนต์เพื่อป้องกันล้อขยับ ---
    ...
    try:
        while True:
            ...
            # ค้นหาวัตถุด้วย Mask และ Contour
            ...
            if contours:
                ...
                if key_pressed == ord('c'):
                    if w > 0 and h > 0:
                        ...
                        print("="*30)
                        print("Copy these K_X and K_Y values into your main script.\n")
            
            # หาขนาดของภาพเพื่อวาด Crosshair
            height, width = frame.shape[:2]
            center_x = width // 2
            center_y = height // 2
            
            # วาดเส้นแนวนอน (ซ้ายไปขวา) - สีเขียว, หนา 2
            cv2.line(frame, (0, center_y), (width, center_y), (0, 255, 0), 2)
            
            # วาดเส้นแนวตั้ง (บนลงล่าง) - สีเขียว, หนา 2
