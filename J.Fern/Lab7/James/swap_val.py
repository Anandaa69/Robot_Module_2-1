...
def main():
    ...
    # ... (ส่วนประมวลผล Template เหมือนเดิม) ...
    templates_masked = []
    templates_original = []
    try:
    ...
    try:
        ...
        while True:
            ...
            # ... (ส่วนประมวลผลภาพและ Template Matching เหมือนเดิม) ...
            ...
            if final_detections:
                ...
                # ... (โค้ดส่วน Template Matching เหมือนเดิม) ...
                ...
                if roi_x2 > roi_x1 and roi_y2 > roi_y1:
                    ...
                    if contours:
                        ...
                        # ==========================[ จุดที่แก้ไขตามสมมติฐาน ]===========================
                        # สลับการใช้ค่า K ในสูตรคำนวณ
                        if w_real > 0:
                            # ระยะทางจากความกว้าง (w_real) แต่ใช้ K_Y
                            distance_z_x = (K_Y * REAL_WIDTH_CM) / w_real
                        if h_real > 0:
                            # ระยะทางจากความสูง (h_real) แต่ใช้ K_X
                            distance_z_y = (K_X * REAL_HEIGHT_CM) / h_real
                        # =========================================================================

            # PID Control
            if target_found:
                # ... (ส่วน PID control loop เหมือนเดิม) ...
            ...
            # แสดงผลระยะทางทั้งสองค่าเพื่อให้เปรียบเทียบกันได้
