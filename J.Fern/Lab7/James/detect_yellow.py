...
# ---------------------------------------------------
# ส่วนที่ 2: การทำงานหลัก (Main Program) - แก้ไขเป้าหมาย PID
# ---------------------------------------------------
    ...
    try:
        ...
        while True:
            ...
            if final_detections:
                ...
                # วาดกรอบสี่เหลี่ยมเดิม (Template Bounding Box) เพื่อการแสดงผล
                ...
                # ค้นหากรอบที่แม่นยำขึ้นจาก Contour
                ...
                if roi_x2 > roi_x1 and roi_y2 > roi_y1:
                    ...
                    if contours:
                        ...
                        # วาด Bounding Box ใหม่ (สีเหลือง)
                        cv2.rectangle(frame, real_top_left, real_bottom_right, (0, 255, 255), 2)

                        # ==========================[ จุดที่แก้ไข ]===========================
                        # คำนวณ Error ของ PID จากจุดศูนย์กลางของ "กรอบสีเหลือง"
                        ...
                        # ตั้งค่าว่าเจอเป้าหมายแล้ว ก็ต่อเมื่อหากรอบจริงเจอเท่านั้น
                        target_found = True
                        
                        # วาดจุดศูนย์กลางของเป้าหมายจริง (สีแดง)
                        cv2.circle(frame, (int(target_center_x), int(target_center_y)), 5, (0, 0, 255), -1)
                        # ===================================================================

            # ส่วนควบคุม PID จะทำงานก็ต่อเมื่อ target_found เป็น True เท่านั้น
            if target_found:
