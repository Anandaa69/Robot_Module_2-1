...
class MovementController:
    ...
    def rotate_90_degrees_right(self,movement_controller=None, attitude_handler=None):
        ...
        target_angle = CURRENT_TARGET_YAW
...
class GraphMapper:
    ...
    def rotate_to_absolute_direction(self, target_direction, movement_controller, attitude_handler=None):
        ...
        if diff == 1:  # Turn right
            ...
            movement_controller.rotate_90_degrees_right(movement_controller,attitude_handler)
            ROBOT_FACE += 1
        elif diff == 3:  # Turn left
            CURRENT_TARGET_YAW += -90
            movement_controller.rotate_90_degrees_left(movement_controller, attitude_handler)
            ROBOT_FACE += 1
        elif diff == 2:  # Turn around (180°)
            CURRENT_TARGET_YAW += -180
            movement_controller.rotate_90_degrees_right(movement_controller, attitude_handler)
            movement_controller.rotate_90_degrees_right(movement_controller, attitude_handler)
            ROBOT_FACE += 2
