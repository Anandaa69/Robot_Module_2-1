...
class GraphMapper:
    ...
    def update_unexplored_exits_absolute(self, node):
        ...
        for direction, target_pos in possible_directions.items():
            ...
            # === เช็คว่าปลายทางเป็นโหนดรอบนอกของแมพหรือไม่ ===
            is_outer = (
            ...
            print(f"      🌐 Is outer border: {is_outer}")
            ...
            if should_explore:
                if is_outer:
                    ...
                    print(f"      🚫 OUTER BORDER! Marked as exit, no exploration.")
                else:
    ...
    def move_to_absolute_direction(self, target_direction, movement_controller, attitude_handler):
        ...
        # === Prevent movement outside border ===
